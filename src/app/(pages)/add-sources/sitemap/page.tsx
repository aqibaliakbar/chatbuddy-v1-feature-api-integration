...
export default function SitemapPage() {
  ...
  useEffect(() => {
    ...
    if (scrapeProgress === 100) {
      toast({
        description: "Sitemap crawling completed successfully!",
        duration: 3000,
      });
      setToastId(null);
    }
  ...
  const handleCrawl = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          error instanceof Error ? error.message : "Failed to crawl sitemap",
        variant: "destructive",
      });
      setToastId(null);
    } finally {
  ...
  // Return JSX with "Website" replaced with "Sitemap"
  return (
    <div className="flex flex-col 2xl:max-w-[72%] ">
          ...
          <div className="flex flex-col 2xl:flex-row items-start 2xl:items-center justify-between gap-4 2xl:gap-2 ">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
              <div className="w-full sm:w-[400px]">
                <Input
                  placeholder="Insert a sitemap URL here..."
                  value={url}
